...
def main():
    ...
    print(val_loader.dataset.num_tokens)
    print(args)

    net = base_model.build_baseline0(val_loader.dataset.num_tokens, hid_dim=1024, v_dim=2048, n_objects=10, max_answers=3000, n_glimpse=2).cuda()
